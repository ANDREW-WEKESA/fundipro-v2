...
const products = [
  // John Mose — Carpenter
  { user_id: fundis[0].id, title: "Mahogany dining table", description: "Seats 6, solid mahogany.", cash_price: 38000, hp_price: 44000, status: "available", photos: [
    "/images/jm-dining-1.jpg", "/images/jm-dining-2.jpg", "/images/jm-dining-3.jpg",
  ], completed_at: daysAgo(20) },
  { user_id: fundis[0].id, title: "Bedside table (pair)", description: "Two matching bedside tables.", cash_price: 9500, hp_price: 11000, status: "available", photos: [
    "/images/jm-bedside-1.jpg", "/images/jm-bedside-2.jpg", "/images/jm-bedside-3.jpg",
  ], completed_at: daysAgo(15) },
  { user_id: fundis[0].id, title: "L-shaped office desk", description: "In the workshop — almost done.", cash_price: 27000, hp_price: 31000, status: "in_progress", photos: [
    "/images/jm-desk-1.jpg", "/images/jm-desk-2.jpg", "/images/jm-desk-3.jpg",
  ], completed_at: null },
  // Grace Nyaboke — Tailor
  ...
  { user_id: fundis[1].id, title: "School uniform set", description: "Bulk orders welcome, standard or custom colours.", cash_price: 1800, hp_price: 2200, status: "available", photos: [], completed_at: daysAgo(5) },
  { user_id: fundis[1].id, title: "Bridal gown (custom)", description: "Fully custom — lace, satin, or chiffon.", cash_price: 22000, hp_price: 26000, status: "available", photos: [], completed_at: daysAgo(22) },
  // Peter Ondieki — Welder
  { user_id: fundis[2].id, title: "Security gate (double leaf)", description: "Heavy gauge steel, powder coated.", cash_price: 32000, hp_price: 37000, status: "available", photos: [], completed_at: daysAgo(18) },
  { user_id: fundis[2].id, title: "Window grills (per window)", description: "Custom designs, priced per window.", cash_price: 4500, hp_price: 5500, status: "available", photos: [], completed_at: daysAgo(8) },
  { user_id: fundis[2].id, title: "Steel staircase railing", description: "Indoor or outdoor, any length.", cash_price: 18000, hp_price: 21000, status: "in_progress", photos: [], completed_at: null },
  // Mary Kerubo — Salon & Beauty
  ...
  { user_id: fundis[3].id, title: "Box braids (full head)", description: "Small, medium, or large — any length.", cash_price: 2500, hp_price: 3000, status: "available", photos: [], completed_at: daysAgo(3) },
  { user_id: fundis[3].id, title: "Keratin treatment", description: "Smooth, frizz-free results that last 3 months.", cash_price: 3500, hp_price: 4200, status: "available", photos: [], completed_at: daysAgo(7) },
  // Samuel Otieno — Mechanic
  { user_id: fundis[4].id, title: "Full car service", description: "Oil, filters, plugs, and inspection.", cash_price: 4500, hp_price: 5500, status: "available", photos: [], completed_at: daysAgo(4) },
  { user_id: fundis[4].id, title: "Brake pad replacement", description: "Front and rear, all vehicle types.", cash_price: 3200, hp_price: 3800, status: "available", photos: [], completed_at: daysAgo(11) },
  { user_id: fundis[4].id, title: "Engine diagnostics & tune-up", description: "Computer scan + full tune-up.", cash_price: 2800, hp_price: 3300, status: "in_progress", photos: [], completed_at: null },
];
